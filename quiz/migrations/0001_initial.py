# Generated by Django 4.0.5 on 2022-07-21 09:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0002_alter_lecture_material_lec_alter_lecture_subject'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, related_name='subject_quiz', to='api.subject')),
            ],
            options={
                'verbose_name': 'Quiz',
